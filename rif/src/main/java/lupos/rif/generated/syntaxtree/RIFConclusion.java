...
/**
 * JTB node class for the production RIFConclusion:<br>
 ...
 * f3 -> < RPAREN ><br>
 */
public class RIFConclusion implements INode {
   ...
   */
  public RIFConclusion(final NodeToken n0, final NodeToken n1, final RIFFormula n2, final NodeToken n3) {
    f0 = n0;
    if (f0 != null)
      f0.setParent(this);
    f1 = n1;
