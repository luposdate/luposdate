...
public class SuggestionFrame extends JFrame {
	...
	protected JPanel createPrecedingSuggestionsPanel(
		...
		subjectPanel = new SuggestionPanel(this.queryGraph, new QueryRDFTerm(
				this.queryGraph.prefix), variablesSubj, rowPanel);
	...
	protected JPanel createSucceedingSuggestionsPanel(
		...
		objectPanel = new SuggestionPanel(this.queryGraph, new QueryRDFTerm(
				this.queryGraph.prefix), variablesObj, rowPanel);
